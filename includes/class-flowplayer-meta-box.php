	...
	public function display_video_meta_box( $post ) {
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					<th scope="row"><label for="fp5-splash-image"><?php _e( 'Flowplayer Drive', $this->plugin_slug )?></label> <a href="http://flowplayer.org/docs/index.html#splash" target="_blank">?</a></th>
					<td>
