...
class fp5_metabox {
	...
	public function display_fp5_video_meta_box( $post ) {
		...
		<p>
			...
			<input class="mediaUrl" type="text" id="splash-image" size="70" value="<?php if ( isset ( $fp5_stored_meta['splash-image'] ) )  $fp5_stored_meta['splash-image'][0]?>" name="splash-image" />
