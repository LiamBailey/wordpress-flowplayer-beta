...
function fp5_Video_details($post) {
	...
	<div class="options" xmlns="http://www.w3.org/1999/html">
			...
			<?php
			echo '<div id="tgm-new-media-settings">';
				echo '<p><label for="tgm-new-media-image">' . __( 'mp4 video', 'flowplayer5' ) . '</label> <input type="text" id="tgm-new-media-image" size="70" value="" /> <a href="#" class="tgm-open-media button button-primary" title="' . esc_attr__( 'Add mp4 video', 'flowplayer5' ) . '">' . __( 'Add mp4 video', 'flowplayer5' ) . '</a></p>';
			echo '</div>';
			?>
